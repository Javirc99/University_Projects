    ...
    ***********************************************************************************************************/
    ...
    void fill(std::vector<std::shared_ptr<Test>> &vec, int num) {
        for (int i = 0; i < num; i++) {
            int initial;
            std::cout << "Set the data (int) for Test object " << i + 1 << ": ";
            std::cin >> initial;
            std::shared_ptr<Test> obj = std::make_shared<Test>(initial);
            vec.push_back(obj);
        }
    }
...
void display(const std::vector<std::shared_ptr<Test>>&vec){
    ...
    std::cout << std::endl << "================ Displaying Vector Data ================" << std::endl; 
    for(auto &comp : vec){
        std::cout << comp->get_data() << std::endl;
    }
