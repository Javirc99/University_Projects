...
void find_test()
{
    ...
    if (loc1 != players.end())
        std::cout << "Found Moe in the list" << std::endl;
    else
        std::cout << "Didn't find Moe" << std::endl;
}
...
void count_if_test()
{
    ...
    num = std::count_if(vec.begin(), vec.end(), [](int x)
                        { return x >= 5; });
    std::cout << num << " numbers are greater or equal than 5" << std::endl;
}

// Replace ocurrences of elements in a container
void replace_test()
{
    std::cout << "\n====================================" << std::endl;
...
void all_of_test()
{
    ...
    if (std::all_of(vec1.begin(), vec1.end(), [](int x)
                    { return x > 10; }))
        std::cout << "All of the elements in the vector are > 10" << std::endl;
    else
        std::cout << "Not all of the elements in the vector are > 10" << std::endl;

    if (std::all_of(vec1.begin(), vec1.end(), [](int x)
                    { return x < 20; }))
        std::cout << "All of the elements in the vector are < 20" << std::endl;
    else
        std::cout << "Not all of the elements in the vector are < 20" << std::endl;
}
