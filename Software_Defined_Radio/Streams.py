...
class Streams(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Streams")
        ...
        self.connect((self.blocks_vector_to_streams_0, 1), (self.qtgui_time_sink_x_0_0, 0))
...
def main(top_block_cls=Streams, options=None):
